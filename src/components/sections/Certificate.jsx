                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                      ...
                      <div className="p-4 sm:p-6 lg:p-8 xl:p-10 flex flex-col justify-center">
                        ...
                        <div className="mb-4 sm:mb-6">
                          <h4 className="text-[10px] sm:text-xs lg:text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 sm:mb-3">
                            Skills Acquired
                          </h4>
                          <div className="flex flex-wrap gap-1.5 sm:gap-2">
                            ...
                            {cert.skills.length > 4 && (
                              <span className="px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs text-gray-500 dark:text-gray-400">
